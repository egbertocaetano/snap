...
{
      32,     0,    -1,    35,    33,    -1,    41,    26,    34,    -1,
      34,    -1,    16,     7,    27,    28,    38,    -1,    -1,    29,
      -1,    30,    -1,    36,    39,    37,    -1,    40,    -1,    40,
      39,    -1,    42,    26,    -1,    43,    26,    -1,     9,    27,
      44,    28,    38,    -1,    45,     8,    15,    46,    -1,    45,
       8,    -1,    45,     8,    15,    46,    -1,    45,     8,    15,
      44,    -1,    45,     8,    -1,     8,    15,    44,    -1,    27,
      44,    28,    -1,    44,    14,    44,    -1,    44,    13,    44,
      -1,    44,    12,    44,    -1,    46,    -1,     8,    -1,    16,
...
{
       0,    79,    79,    86,    94,    96,   105,   110,   116,   121,
     127,   131,   138,   139,   140,   150,   154,   159,   165,   171,
     176,   184,   189,   194,   211,   234,   235,   251,   251,   251,
     251,   251,   253,   257,   261,   265
};
#endif
...
static const char *const yytname[] =
{
  ...
  "TK_CHAR", "TK_MAIN", "TK_ID", "TK_IF", "TK_FIM", "TK_ERROR",
...
{
       6,     0,     0,     1,    27,    28,    29,    30,    31,     2,
       4,     0,     0,     0,     0,    16,     0,     0,     3,     0,
       0,    32,    33,    35,    34,    15,     7,     0,     5,     0,
       0,    27,     0,    10,     0,     0,     0,     0,     0,     8,
       9,    11,    12,    13,    19,    26,     0,    20,    25,     0,
       0,     0,     0,     0,     0,     0,    18,    25,    21,    24,
      23,    22,    14
};
...
{
     -34,    10,    23,   -34,     4,   -34,   -34,   -34,   -34,   -34,
     -34,   -14,    14,    -9,     8,    13,     1,     4,   -34,    41,
       3,   -34,   -34,   -34,   -34,   -34,   -34,    18,   -34,    37,
       6,   -34,    21,    18,    27,    28,    47,    -2,    -2,   -34,
     -34,   -34,   -34,   -34,    42,   -34,    -2,    36,   -34,    -5,
      -2,     2,    -2,    -2,    -2,     3,    36,    30,   -34,    36,
      36,    36,   -34
};
...
{
      25,    21,    22,    23,    24,    49,    45,    52,    53,    54,
       3,    13,    14,    51,    52,    53,    54,    56,    16,    59,
      60,    61,    15,    55,    17,    46,    29,    30,    19,    20,
      58,    57,    26,    38,    31,     5,     6,     7,     8,     4,
       5,     6,     7,     8,    21,    22,    23,    24,    52,    53,
      54,    39,    37,    42,    43,    44,   -17,    50,    18,    41,
      62,    12
};
...
{
      19,     3,     4,     5,     6,    38,     8,    12,    13,    14,
       0,     7,    26,    46,    12,    13,    14,    50,    27,    52,
      53,    54,     8,    28,    16,    27,     8,     9,    15,    28,
      28,    50,    29,    27,    16,    17,    18,    19,    20,    16,
      17,    18,    19,    20,     3,     4,     5,     6,    12,    13,
      14,    30,    15,    26,    26,     8,    26,    15,    14,    33,
      55,     2
};
...
{
       0,    32,    35,     0,    16,    17,    18,    19,    20,    33,
      34,    41,    45,     7,    26,     8,    27,    16,    34,    15,
      28,     3,     4,     5,     6,    46,    29,    36,    38,     8,
       9,    16,    39,    40,    42,    43,    45,    15,    27,    30,
      37,    39,    26,    26,     8,     8,    27,    44,    46,    44,
      15,    44,    12,    13,    14,    28,    44,    46,    28,    44,
      44,    44,    38
};
...
#line 151 "sintatica.y"
    {
				processaDECLARACAO(&(yyval), &(yyvsp[(1) - (4)]), &(yyvsp[(2) - (4)]), &(yyvsp[(3) - (4)]), &(yyvsp[(4) - (4)]), GLOBAL);
			}
    break;
...
#line 155 "sintatica.y"
    {
				processaTK_ID(&(yyval), &(yyvsp[(1) - (2)]), &(yyvsp[(2) - (2)]), GLOBAL);
			}
    break;
...
#line 160 "sintatica.y"
    {
				...
				processaDECLARACAO(&(yyval), &(yyvsp[(1) - (4)]), &(yyvsp[(2) - (4)]), &(yyvsp[(3) - (4)]), &(yyvsp[(4) - (4)]), LOCAL);
...
#line 172 "sintatica.y"
    {
				 processaTK_ID(&(yyval), &(yyvsp[(1) - (2)]), &(yyvsp[(2) - (2)]), LOCAL);
			}
    break;
...
#line 177 "sintatica.y"
    {	
				...
				processaATRIBUICAO(&(yyval), &(yyvsp[(1) - (3)]), &(yyvsp[(2) - (3)]), &(yyvsp[(3) - (3)]));
...
#line 190 "sintatica.y"
    {
				operacaoAritmetica(&(yyval), &(yyvsp[(1) - (3)]), &(yyvsp[(2) - (3)]), &(yyvsp[(3) - (3)])); 
...
#line 195 "sintatica.y"
    {
				...
				{
					string tipo = getTipo((yyvsp[(1) - (3)]).tipo +  (yyvsp[(2) - (3)]).operador + (yyvsp[(3) - (3)]).tipo);
					(yyval).tmp = geraTemp(tipo, LOCAL);
					(yyval).tipo = tipo;	
					(yyval).traducao = (yyvsp[(1) - (3)]).traducao + (yyvsp[(3) - (3)]).traducao + "\t" + (yyval).tmp + " = " + (yyvsp[(1) - (3)]).tmp + (yyvsp[(2) - (3)]).operador + (yyvsp[(3) - (3)]).tmp + ";\n";
				}	
				else
				{
					(yyval).tmp = geraTemp((yyvsp[(1) - (3)]).tipo, LOCAL);
...
#line 236 "sintatica.y"
    {
				//Nessa parte precisa verificar se TK_ID pertence ao contexto atual
				TABELA * tab = existeID((yyvsp[(1) - (1)]).label);

				if(tab != NULL)
				{
					(yyval).tmp = (*tab)[(yyvsp[(1) - (1)]).label].tmp;
					(yyval).label = (*tab)[(yyvsp[(1) - (1)]).label].label;
					(yyval).valor = (*tab)[(yyvsp[(1) - (1)]).label].valor;
					(yyval).tipo = (*tab)[(yyvsp[(1) - (1)]).label].tipo;
				}
...
#line 254 "sintatica.y"
    {
				processaTK_VALOR(&(yyval), &(yyvsp[(1) - (1)]), "int");
			}
    break;
...
#line 258 "sintatica.y"
    {
				processaTK_VALOR(&(yyval), &(yyvsp[(1) - (1)]), "float");
			}
    break;
...
#line 262 "sintatica.y"
    {
				processaTK_VALOR(&(yyval), &(yyvsp[(1) - (1)]), "char");
			}
    break;
...
#line 266 "sintatica.y"
    {	
				if((yyvsp[(1) - (1)]).valor == "TRUE")
					(yyvsp[(1) - (1)]).valor = "1";
				else
					(yyvsp[(1) - (1)]).valor = "0";
				 
				processaTK_VALOR(&(yyval), &(yyvsp[(1) - (1)]), "boolean");
			}
    break;
