...
{
       0,    60,    60,    66,    72,    76,    83,    84,    87,   122,
     155,   168,   188,   193,   210,   211,   225,   225,   225,   227,
     227,   227,   227,   227,   229,   235,   241,   247
};
#endif
...
static const char *const yytname[] =
{
  ...
  "COMANDO", "DECLARACAO", "ATRIBUICAO", "E", "OPERADOR", "TIPO", "VALOR", YY_NULLPTR
};
#endif
...
{
      -6,     3,    17,    -7,   -16,     2,     4,    -4,   -16,     6,
     -16,   -16,   -16,   -16,   -16,     1,    -4,     5,     7,    15,
      -3,   -16,   -16,   -16,   -16,    16,   -16,   -16,   -16,   -16,
     -16,    -3,    14,   -16,    -3,    -5,   -16,   -16,   -16,    -3,
      14,     8,   -16,    14
};
...
{
       0,     0,     0,     0,     1,     0,     0,     0,     2,     0,
      19,    20,    21,    22,    23,     0,     4,     0,     0,     0,
       0,     3,     5,     6,     7,    10,    24,    25,    27,    26,
      15,     0,    11,    14,     0,     0,    16,    17,    18,     0,
       9,    14,    12,    13
};
...
{
      26,    27,    28,    29,     9,    30,    36,    37,    38,     1,
       3,    10,    11,    12,    13,    14,    35,     4,     5,    40,
      20,    42,    31,    25,    43,    36,    37,    38,     6,    21,
      34,     7,    41,     0,    23,    22,    24,    -8
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,     8,     8,    11,    12,    13,    15,
       7,    15,    16,    17,    18,    19,    31,     0,    25,    34,
      14,    26,    25,     8,    39,    11,    12,    13,    26,    28,
      14,    27,    34,    -1,    29,    16,    29,    29
};
...
{
       0,    15,    31,     7,     0,    25,    26,    27,    32,     8,
      15,    16,    17,    18,    19,    33,    34,    35,    36,    39,
      14,    28,    33,    29,    29,     8,     3,     4,     5,     6,
       8,    25,    37,    40,    14,    37,    11,    12,    13,    38,
      37,    40,    26,    37
};
...
#line 88 "sintatica.y" /* yacc.c:1646  */
    {
				...
				{	
					string tipo = getTipo((yyvsp[-3]).tipo + (yyvsp[-1]).operador + (yyvsp[0]).tipo);

					struct ID id;
					id.temp =  geraTemp();
					id.tipo = (yyvsp[-3]).tipo;
					id.label = (yyvsp[-2]).label;
					id.valor = (yyvsp[0]).valor;
					(yyval).tmp = id.temp;
					(yyval).label = id.label;
					tabID[(yyval).label] = id;
					
					(yyval).traducao = (yyvsp[-3]).traducao + (yyvsp[0]).traducao + "\t" + tabID[(yyval).label].tipo + " " + tabID[(yyvsp[-2]).label].temp + " = " + "(" + tipo + ") " + (yyvsp[-1]).tmp + ";\n";
				}	
				else
				{
					struct ID id;
					...
					(yyval).label = id.label;
					tabID[(yyval).label] = id;
					(yyval).traducao = (yyvsp[0]).traducao + "\t" + tabID[(yyval).label].tipo + " " + tabID[(yyvsp[-2]).label].temp + " = " + (yyvsp[0]).tmp + ";\n";
...
#line 123 "sintatica.y" /* yacc.c:1646  */
    {
				...
				{	
					...
					(yyval).traducao = (yyvsp[-3]).traducao + (yyvsp[0]).traducao + "\t" + tabID[(yyval).label].tipo + " " +  tabID[(yyvsp[-2]).label].temp + " = " + "(" + tipo + ") " + (yyvsp[0]).tmp + ";\n";
				}	
				else
				{
					struct ID id;
...
#line 156 "sintatica.y" /* yacc.c:1646  */
    {
				...
				(yyval).label = id.label;
				tabID[(yyval).label] = id;
				(yyval).traducao = "\t" + tabID[(yyval).label].tipo + " "  + (yyval).tmp + ";\n";
			}
...
#line 169 "sintatica.y" /* yacc.c:1646  */
    {
				if(existeID((yyvsp[-2]).label))
				{

					//Verificando tipo das variaveis para decidir o tipo da nova variavel temporaria 
					if((yyvsp[-2]).tipo != (yyvsp[0]).tipo)
					{	
						string tipo = getTipo(tabID[(yyvsp[-2]).label].tipo + (yyvsp[-1]).operador + (yyvsp[0]).tipo);	
						(yyval).traducao = (yyvsp[-2]).traducao + (yyvsp[0]).traducao + "\t" + tabID[(yyvsp[-2]).label].temp + " = " + "(" + tipo + ") " + (yyvsp[0]).tmp + ";\n";
					}	
					else 
					{
						(yyval).traducao = (yyvsp[-2]).traducao + (yyvsp[0]).traducao + "\t" + tabID[(yyvsp[-2]).label].temp + " = " + (yyvsp[0]).tmp + ";\n";
					}
...
#line 194 "sintatica.y" /* yacc.c:1646  */
    {
				...
				if((yyvsp[-2]).tipo != (yyvsp[0]).tipo)
				{
					...
					(yyval).tmp = geraTemp();
					(yyval).tipo = tipo;	
					(yyval).traducao = (yyvsp[-2]).traducao + (yyvsp[0]).traducao + "\t" + tipo + " " + (yyval).tmp + " = " + (yyvsp[-2]).tmp + (yyvsp[-1]).operador + (yyvsp[0]).tmp + ";\n";
				}	
				else
				{
					(yyval).tmp = geraTemp();
					(yyval).tipo = (yyvsp[-2]).tipo;	
					(yyval).traducao = (yyvsp[-2]).traducao + (yyvsp[0]).traducao + "\t" + (yyvsp[-2]).tipo + " " + (yyval).tmp + " = " + (yyvsp[-2]).tmp + (yyvsp[-1]).operador + (yyvsp[0]).tmp + ";\n";	
				}
			}
...
#line 212 "sintatica.y" /* yacc.c:1646  */
    {
				if(existeID((yyvsp[0]).label))
				{
					(yyval).tmp = tabID[(yyvsp[0]).label].temp;
					(yyval).label = tabID[(yyval).label].label;
					(yyval).valor = tabID[(yyval).label].valor;
					(yyval).tipo = tabID[(yyval).label].tipo;
...
#line 230 "sintatica.y" /* yacc.c:1646  */
    {
				...
				(yyval).traducao = "\t" + (yyvsp[0]).tipo + " " + (yyval).tmp + " = " + (yyvsp[0]).valor + ";\n";
			}
