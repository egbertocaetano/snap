...
static const yytype_uint8 yyrline[] =
{
     ...
     107,   113,   118,   127,   128,   140,   140,   140,   142,   142,
     142,   142,   142,   144,   149,   154,   159
};
#endif
...
static const char *const yytname[] =
{
  ...
  "TK_TIPO_INT", "TK_TIPO_CHAR", "TK_TIPO_FLOAT", "TK_TIPO_STRING",
  "TK_TIPO_BOOLEAN", "'+'", "'-'", "'*'", "'/'", "'='", "'('", "')'",
  "'{'", "'}'", "';'", "$accept", "S", "BLOCO", "COMANDOS", "COMANDO",
  "DECLARACAO", "ATRIBUICAO", "E", "OPERADOR", "TIPO", "VALOR", YY_NULLPTR
};
#endif
...
{
       1,     9,    18,     5,   -23,    -6,     4,    -4,   -23,     8,
     -23,   -23,   -23,   -23,   -23,     6,    -4,     7,    10,    24,
      -3,   -23,   -23,   -23,   -23,    11,   -23,   -23,   -23,   -23,
     -23,    -3,    15,   -23,    19,    -5,   -23,   -23,   -23,    -3,
     -23,   -23,    15
};
...
{
      26,    27,    28,    29,     9,    30,    36,    37,    38,    35,
      10,    11,    12,    13,    14,     1,     3,    42,     4,     6,
      41,    31,    26,    27,    28,    29,    36,    37,    38,     5,
       7,    20,    25,    21,    34,    23,    22,    40,    24
};

static const yytype_uint8 yycheck[] =
{
       3,     4,     5,     6,     8,     8,    11,    12,    13,    31,
      14,    15,    16,    17,    18,    14,     7,    39,     0,    25,
      25,    24,     3,     4,     5,     6,    11,    12,    13,    24,
      26,    23,     8,    27,    23,    28,    16,    34,    28
};
...
{
       0,    14,    30,     7,     0,    24,    25,    26,    31,     8,
      14,    15,    16,    17,    18,    32,    33,    34,    35,    38,
      23,    27,    32,    28,    28,     8,     3,     4,     5,     6,
       8,    24,    36,    39,    23,    36,    11,    12,    13,    37,
      39,    25,    36
};
...
#line 83 "sintatica.y" /* yacc.c:1646  */
    {
				...
				(yyval).traducao = (yyvsp[0]).traducao + "\t" + tabID[(yyval).label].tipo + " " + (yyval).tmp + " = " + (yyvsp[0]).tmp + ";\n";
			}
...
#line 165 "sintatica.y" /* yacc.c:1906  */
